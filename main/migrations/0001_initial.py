# Generated by Django 3.1.3 on 2021-07-15 03:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Game_Connected', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.game')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Player_Connected', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.player')),
                ('Server_Connected', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.gameserver')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='gameserver',
            name='Server_Host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Server_Host', to='main.player'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
