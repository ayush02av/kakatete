# Generated by Django 3.1.3 on 2021-07-13 08:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Player_Connected', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('Server_Connected', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.game')),
            ],
        ),
        migrations.CreateModel(
            name='GameServer',
            fields=[
                ...
                ('Players_Connected', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
